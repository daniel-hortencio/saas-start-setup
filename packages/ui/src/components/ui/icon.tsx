"use client";
const PHIcon = require("@phosphor-icons/react");
...
export const Icon = ({ name, size = 20, color = "" }: Props) => {
  const Element: any =
    PHIcon[name as keyof typeof PHIcon] ||
    PHIcon["XSquare" as keyof typeof PHIcon];

  return <Element name={name} size={size} color={color} />;
};
